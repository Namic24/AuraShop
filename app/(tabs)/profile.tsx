      ...
      <ScrollView>
        <View className="p-4">
          ...
          <View className="items-center mb-6 mt-5">
            <Image
              source={{ uri: 'https://i.pinimg.com/736x/96/96/89/96968965e1fc315e43e777471ff58942.jpg' }}
              className="w-20 h-20 rounded-full"
            />
            <Text className="text-3xl mt-5" fontWeight='medium'>อาทิตยา เกลื่อนกระโทก</Text>
